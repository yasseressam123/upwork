            ...
            <div className="mb-4 mb-lg-5 row">
              <div className="col-4">
                <div onClick={(e) => handleJobVisibilitySelection(e, "anyone")} className="col-12 col project-type-card visibility-card p-3 rounded">
                  ...
                  <div className="d-none d-xl-block text-center project-card-text mb-3">Freelancers and agencies using upwork and public search engines can find this job.</div>
                </div>
              </div>
              <div className="col-4">
                <div onClick={(e) => handleJobVisibilitySelection(e, "only-upwork")} className="col-12 col project-type-card visibility-card p-3 rounded">
                  <div className="text-right">
                    <input type="radio" id="only-upwork" value="only-upwork" name="job-visibility" />
                  </div>
                  <div className="text-center pb-2">
                  ...
                  <div className="text-center project-card-title">Only Upwork talent</div>
                  <div className="d-none d-xl-block text-center project-card-text mb-3">Only Upwork users can find this job.</div>
                </div>
              </div>
              <div className="col-4">
